    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div
                    class="bg-white overflow-hidden shadow-l1 sm:rounded-2xl border border-neutral-light p-8 mb-6"
                >
                    <div class="flex items-center justify-between">
                        <div>
                            <h3
                                class="font-display text-lg font-semibold text-charcoal mb-2"
                            >
                            ...
                            <p class="font-body text-neutral-stone mb-4">
                                Your profile is
                                <span
                                    :class="`font-semibold ${completenessStatusClass}`"
                            ...
                            <p
                                class="font-body text-sm text-neutral-stone mb-3"
                            >
                                Your profile must have a phone number and resume
                        ...
                        <div class="text-right">
                            <div
                                ...
                                :class="
                                    profile.completeness_percentage === 100
                                        ? 'text-green-600'
                                        : 'text-orange-600'
                                "
                            >
                ...
                <!-- Profile Form Card -->
                <div
                    class="bg-white overflow-hidden shadow-l1 sm:rounded-2xl border border-neutral-light p-8"
                >
                    <h3 class="font-display text-2xl mb-6 text-charcoal">
                        Edit Profile
                    </h3>
                    ...
                    >
                        <p class="font-body text-green-700">
                    ...
                    <form @submit.prevent="submitForm" class="space-y-6">
                        ...
                        <div>
                            <label
                                for="title"
                                class="block font-body font-medium text-charcoal mb-2"
                            >
                                Professional Title
                            </label>
                            <input
                            ...
                            <p
                                ...
                                class="font-body text-red-600 text-sm mt-1"
                            >
                                {{ form.errors.title }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="font-body text-neutral-stone text-sm mt-1"
                            >
                        ...
                        <div>
                            ...
                            <p
                                ...
                                class="font-body text-red-600 text-sm"
                            >
                                {{ form.errors.skills }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                <p
                                    class="font-body font-semibold text-blue-900 mb-2"
                                >
                                    Current Resume
                                </p>
                                ...
                                <p
                                    v-if="profile.resume_uploaded_at"
                                    class="font-body text-blue-800 text-sm mb-3"
                                >
                            ...
                            <div
                                ...
                                "
                                @drop.prevent="
                                    form.resume = $event.dataTransfer.files[0]
                                "
                            >
                                <input
                                    ref="resumeInput"
                                ...
                                />
                                <p
                                    class="font-body font-semibold text-charcoal mb-1"
                                >
                                    {{
                                        form.resume
                                            ? form.resume.name
                            ...
                            <p
                                ...
                                class="font-body text-red-600 text-sm mt-2"
                            >
                                {{ form.errors.resume }}
                            </p>
                            <p
                                class="font-body text-neutral-stone text-sm mt-2"
                            >
                                Required for profile completeness
                            </p>
                        </div>
